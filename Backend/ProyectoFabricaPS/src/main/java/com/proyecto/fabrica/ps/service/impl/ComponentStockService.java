...
public class ComponentStockService implements IComponentStockService {
	...
	private Response createResponse(int statusCode, String message, ComponentStockDTO componentStockDTO) {
	...
	public Response addStock(Long componentId, int quantity) {
		...
		try {
			...
			if( optionalComponent.isEmpty()) {
				...
				return createResponse(400, "Componente no encontrado con ID: " + componentId, null);
			...
			ComponentStockDTO componentStockDTO = componentStockMapper.componentToComponentStockDTO(updatedComponent);
		
			return createResponse(200, "Stock Actualizado correctamente.", componentStockDTO);
		
		} catch (Exception e) {
	
			return createResponse(500, "Error al actualizar el stock: " + e.getMessage(), null);
	...
	public Response reduceStock(Long componentId, int quantity) {
		...
		try {
            ...
            if (component.getStock() < quantity) {
            	...
            	return createResponse(400, "Stock insuficiente para reducir.", null);
            ...
            return createResponse(200, "Stock reducido correctamente.", componentStockDTO);

        } catch (Exception e) {
          
        	return createResponse(500, "Error al reducir el stock: " + e.getMessage(), null);
	...
	public Response getStockByComponentId(Long componentId) {
		 ...
		 try {
	            ...
	            return createResponse(200, "Stock obtenido correctamente.", componentStockDTO);

	        } catch (Exception e) {
	         
	        	return createResponse(500, "Error al obtener el stock: " + e.getMessage(), null);
